defmodule Precider.Accounts do
  @moduledoc """
  ...
  alias Precider.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Precider.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Precider.Accounts.User.password_changeset/3` for a list of supported options.
