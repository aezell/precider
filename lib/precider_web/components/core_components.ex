defmodule PreciderWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: PreciderWeb.Gettext
  ...
  """
  attr :rest, :global, include: ~w(href navigate patch method name value)
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PreciderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PreciderWeb.Gettext, "errors", msg, opts)
    end
  end
